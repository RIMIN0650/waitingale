...
<template>
    <header class="h-16 bg-white/90 backdrop-blur-md border-b border-slate-200 flex items-center justify-between px-6 z-10 shrink-0">
      ...
      <div class="hidden md:flex w-64 flex-col bg-white border-r border-slate-200 z-20">
         <div class="h-16 flex items-center px-4 border-b border-slate-100">
            <a href="#" class="flex items-center gap-2">
             <img src="@/assets/images/mediQ_logo.png" alt="Logo" class="w-8 h-8 object-contain" @error="e => (e.target.src = 'https://via.placeholder.com/32')">
      ...
      <div class="flex-1 min-w-0 pl-4 mr-6">
        <div class="relative">
